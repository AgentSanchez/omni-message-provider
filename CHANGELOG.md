...
### Fixed
- **Jira**: Bot account ID resolution moved from init to first poll cycle — prevents startup failures in cluster environments when network/sidecar not yet ready
